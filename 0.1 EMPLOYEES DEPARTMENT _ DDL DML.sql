...
INSERT INTO employees (employee_id, first_name, last_name, email, phone_number, hire_date, job_id, salary, manager_id, department_id) VALUES
(207, 'Steven', 'King', 'steven.king@sqltutorial.org', '515.123.4567',date '1987-06-17', 4, '24000.00', NULL, 9);
INSERT INTO employees (employee_id, first_name, last_name, email, phone_number, hire_date, job_id, salary, manager_id, department_id) VALUES
(208, 'Karen', 'Partners', 'karen.partners@sqltutorial.org', NULL,date '1997-01-05', 15, '13500.00', 100, 8);
...
RENAME TO employees11; 

ALTER TABLE departments   
RENAME TO departments11;  
...
select * from employee_details where FIRST_NAME='james';
